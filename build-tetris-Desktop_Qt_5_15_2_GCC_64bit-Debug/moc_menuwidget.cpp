...
#include <memory>
#include "../tetris/widgets/menu/menuwidget.h"
...
QT_MOC_LITERAL(1, 11, 17), // "gameButtonPressed"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 21), // "settingsButtonPressed"
QT_MOC_LITERAL(4, 52, 18) // "aboutButtonPressed"

    },
    "MenuWidget\0gameButtonPressed\0\0"
    "settingsButtonPressed\0aboutButtonPressed"
};
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gameButtonPressed(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWidget::gameButtonPressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MenuWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWidget::settingsButtonPressed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MenuWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWidget::aboutButtonPressed)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MenuWidget::gameButtonPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuWidget::settingsButtonPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MenuWidget::aboutButtonPressed()
{
